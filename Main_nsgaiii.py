...
class NSGA_III_DCHDH(ElementwiseProblem):  # Class where the present problem is declared for NSGA-II, inheriting from one of pymoo's classes
    ...
    # The object "Caldef" is now assigned the initial values
        ...
        print(self.i, round(f1, 2), round(f2, 2), round(f3, 2))
        self.i += 1
